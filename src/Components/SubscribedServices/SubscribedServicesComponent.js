...
const cards = [
    ...
    { id: 2, title: 'Collabera DevOps Platform(CDP)', discription: 'discription not available', image: 'https://quantummile.com/wp-content/uploads/2018/03/DevOps-FAQ-1280x720-600x300.jpg', learnMorelink: '#', letsGolink: './subscribedservices/CDP' },
