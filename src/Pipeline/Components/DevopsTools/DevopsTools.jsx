    ...
    <div id="myprojects">
      ...
      <Grid container className="container">
        <Grid direction="row" className="topbar">
          <Button href="/pipeline/devopstools/add-devops-tool" type="button" variant="outlined" color="primary">
            ...
            <Grid key={proj.id} item>
              <Card>
                ...
                <CardActions className="buttons">
                  <Grid item xs={3}>
                    <Button variant="contained" color="primary" fullWidth href="/pipeline/devopstools/add-devops-tool">Edit</Button>
                  </Grid>
                  <Grid item xs={3}>
