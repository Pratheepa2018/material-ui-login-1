  ...
  return (
    <div id="myprojects">
      ...
      <Grid container className="container">
        <section>
          <Button href="/pipeline/Projects/AddNewProject" type="button" variant="outlined" color="primary">
              ...
              <Grid key={proj.id} item>
                <Card>
                  ...
                  <CardActions className="buttons">
                    ...
                    <Button size="small" color="primary" href="pipeline/Projects/AddNewProject">
                      <svg viewBox="0 0 24 24">
